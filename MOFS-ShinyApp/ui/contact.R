                ...
                column(
                  ...
                  fluidRow(
                    column(
                      ...
                      tags$p("No.1 Jianshe Dong Road, ErQi District, Zhengzhou, Henan province 450052, China.",
                             style = "font-size:100%"),
                      ...
                      tags$br(),
                      tags$a(href='https://www.zdyfy.com/ywb',target="_blank","First Affiliated Hospital of Zhengzhou University"),
